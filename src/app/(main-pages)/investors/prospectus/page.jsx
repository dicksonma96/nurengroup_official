    ...
    <div className="prospectus col">
      ...
      <div className="content col">
        ...
        <p>
          ...
          conditions of access. The information on this page is not part of the
          Prospectus. If you do not understand it, you should consult your
          professional advisor.
        </p>
        <h3>IMPORTANT NOTICE</h3>
        <p>
          Nuren Group Limited ACN 673 015 597 (Company) has lodged a prospectus
          dated 28 May 2024 (Prospectus) with the Australian Securities and
          Investments Commission (ASIC) containing an offer of 3,000,000
          ordinary shares in the Company, at an issue price of $0.20, raising a
          total of $600,000. We may accept oversubscription of up to an
          additional 500,000 ordinary shares at same issue price, raising an
          additional $100,000.
          <br /> <br />
          ...
          <br /> <br />
          Except as required by law, and only to the extent required, no person
          named in the Prospectus, nor any other person, warrants or guarantees
          the Company’s performance, the repayment of capital by the Company or
          any return on investment made pursuant to the Prospectus.
          <br />
          <br />
          ...
          the key risks are set out in Section 6 of the Prospectus. If you have
          any questions about the Offer or any other matter, please contact your
          professional advisor. Neither ASIC nor NSX, nor any of their
          respective officers, take any responsibility for the contents of the
          Prospectus or the merits of the investment to which the Prospectus
          relates.
          <br />
          <br />
          ...
          securities. You may print out a hard copy of the Prospectus from this
          website or copy the electronic Prospectus on this website into an
          electronic file for your personal use only. You must not alter the
          contents of this electronic file in any way. Alternatively, you may
          also obtain a copy of the Prospectus by contacting the Share Registry
          at Automic Pty Ltd at 1300288664 (within Australia) or +612-96985414
          (outside Australia) between 9:00am and 5:00pm AEDT (Monday to Friday)
          or email to hello@automic.com.au.
          <br />
          <br />
          To the extent permitted by law, the Company is not liable for any loss
          incurred from accessing or downloading the Prospectus from this
        ...
        <p>
          ...
          monies paid, in accordance with the details set out in the Prospectus
          and application form. The Corporations Act 2001 (Cth) prohibits any
          person from passing onto another person an Application Form unless it
          is attached to or accompanied by a complete and unaltered version of
          the Prospectus.
          <br />
          <br />
          ...
          together with the Prospectus or any of those documents were incomplete
          or altered. If an application form is not completed correctly or if
          the accompanying payment is the wrong amount, the Company may, in its
        ...
        <p>
          ...
          your professional advisor for investment, financial, legal, business
          or tax advice.
        </p>

        <h3>PERSONS TO WHOM THE PROSPECTUS IS AVAILABLE</h3>
        <p>
          For legal reasons, the electronic version of the Prospectus accessible
          through this website is available to persons accessing this website
          from within Australia only. If you are accessing this website from
          anywhere outside Australia, please do not download the electronic
          version of the Prospectus.
          <br />
          <br />
          The Prospectus does not constitute an offer of, or invitation to apply
          for, securities in any jurisdiction where, or to any person to whom,
          it would not be lawful to issue the Prospectus or to make the offer or
          invitation. It is the responsibility of any applicant outside
          Australia to ensure compliance with all laws of any country relevant
          to their applications, and any such applicant should consult their
          professional advisor as to whether any government or other consents
          are required, or whether any formalities need to be observed to enable
          them to apply for and be allotted any securities.
        </p>
        <h3>DISCLAIMER</h3>
        <p>
          As set out in the Prospectus, it is proposed that the Shares will be
          quoted on the NSX. The Company, the Share Registry, and the Nominated
          Advisor (each as defined in the Prospectus) disclaim all liability,
          whether in negligence or otherwise, to persons who trade Shares before
          receiving their holding statements.
        </p>
        <h3>ACKNOWLEDGEMENT</h3>
        <p>
          This notice does not form part of the Prospectus. You must read it
          before you attempt to access the electronic version of the Prospectus
          on this website and indicate your agreement or otherwise at the bottom
          of this page.
          <br />
          <br />
